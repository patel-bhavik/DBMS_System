...
public class Buffer {
	...
	private boolean logNature = false;
	...
	private Stack<Long> timestamps = new Stack<Long>();
	...
	public void setContents(Page contents) {
		this.contents = contents;
	}
	
	public void setLogNature(boolean logNature) {
		this.logNature = logNature;
	}

	public boolean isLogNature() {
		return logNature;
	}
	...
	public Stack<Long> getTimestamps() {
		return timestamps;
	}
